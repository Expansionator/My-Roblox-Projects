...
return {
	...
	Globals = {
		...
		PreviousVersionSupport = false, -- [Important]
	...
	Datastore = {
		...
		ProfileLockText = "Looks like a session is already active. Please try again in a moment.",

		--// For DeleteProfile(), the kick message shown once the player is kicked
		ProfileDeletionText = "Your data has been cleared. If you join the game again, new data will be created.",
